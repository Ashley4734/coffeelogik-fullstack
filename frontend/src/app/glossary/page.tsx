...
// Note: This is now a client component, so metadata should be moved to a separate file
// or use the generateMetadata function in a parent layout if SEO is needed
