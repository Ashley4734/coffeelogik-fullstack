...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    brewing_guides: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiBrewingGuideBrewingGuide
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    step_images: Schema.Attribute.Media<'images' | 'files', true>;
...
export interface ApiCoffeeProductCoffeeProduct
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    featured: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    flavor_notes: Schema.Attribute.JSON;
    ...
    rating: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    roast_level: Schema.Attribute.Enumeration<
...
export interface ApiCoffeeRecipeCoffeeRecipe
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    author: Schema.Attribute.Relation<'manyToOne', 'api::author.author'>;
    brew_method: Schema.Attribute.Enumeration<
      [
        'Espresso',
        'Pour Over',
        'French Press',
    ...
    >;
    coffee_amount: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 50;
      }>;
    createdAt: Schema.Attribute.DateTime;
    ...
    difficulty_level: Schema.Attribute.Enumeration<
      ['Beginner', 'Intermediate', 'Advanced']
    >;
    equipment_needed: Schema.Attribute.JSON;
    featured: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    featured_image: Schema.Attribute.Media<'images'>;
    grind_size: Schema.Attribute.Enumeration<
      [
        'Extra Fine',
        'Fine',
        'Medium-Fine',
    ...
    servings: Schema.Attribute.Integer &
      ...
      Schema.Attribute.DefaultTo<1>;
    slug: Schema.Attribute.UID<'name'> & Schema.Attribute.Required;
    step_images: Schema.Attribute.Media<'images', true>;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    water_amount: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 50;
      }>;
    water_temperature: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 50;
      }>;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::brewing-guide.brewing-guide': ApiBrewingGuideBrewingGuide;
      'api::category.category': ApiCategoryCategory;
      'api::coffee-product.coffee-product': ApiCoffeeProductCoffeeProduct;
      'api::coffee-recipe.coffee-recipe': ApiCoffeeRecipeCoffeeRecipe;
